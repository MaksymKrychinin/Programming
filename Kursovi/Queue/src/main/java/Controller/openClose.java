...
@WebServlet(name = "openClose", value = "/openClose")
public class openClose extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (queueId==idCurrentUser){
            int status = Integer.parseInt(request.getParameter("openClose"));
            QueueDAO queueDAO = new QueueDAO();
            queueDAO.openClose(queueId, status);
